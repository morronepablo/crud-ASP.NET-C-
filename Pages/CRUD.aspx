...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <form runat="server" class="h-100 d-flex align-items-center justify-content-center">
        <div>
            ...
            <asp:Button runat="server" CssClass="btn btn-success" ID="BtnUpdate" Text="Update" Visible="false" OnClick="BtnUpdate_Click" />
            <asp:Button runat="server" CssClass="btn btn-danger" ID="BtnDelete" Text="Delete" Visible="false" OnClick="BtnDelete_Click" />
